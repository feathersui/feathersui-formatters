...
class TestMain extends Sprite {
	public function new() {
		...
		runner.addCase(new feathers.formatters.TestCurrencyFormatter());
		runner.addCase(new feathers.formatters.TestDateFormatter());
		runner.addCase(new feathers.formatters.TestNumberFormatter());
		runner.addCase(new feathers.formatters.TestPhoneFormatter());
		runner.addCase(new feathers.formatters.TestZipCodeFormatter());
