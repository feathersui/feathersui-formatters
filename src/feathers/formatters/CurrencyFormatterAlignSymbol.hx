...
/**
	The CurrencyFormatterAlignSymbol class defines value constants
	for specifying currency symbol alignment.
	These values are used in the `CurrencyFormatter.alignSymbol`
	property.

	@see `feathers.formatters.CurrencyFormatter`
**/
final class CurrencyFormatterAlignSymbol {
	//--------------------------------------------------------------------------
	//
	//  Class constants
	//
	...
	/**
		...
		for the CurrencyFormatter class.
	**/
